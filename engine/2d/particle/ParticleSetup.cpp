...
void ParticleSetup::CreateGraphicsPipeline() {
	...
	blendDesc.RenderTarget[0].DestBlend = D3D12_BLEND_ONE;       // 背景をそのまま使用(加算合成)
	blendDesc.RenderTarget[0].BlendOp = D3D12_BLEND_OP_ADD;
	blendDesc.RenderTarget[0].SrcBlendAlpha = D3D12_BLEND_ONE;
	blendDesc.RenderTarget[0].DestBlendAlpha = D3D12_BLEND_ZERO;
	blendDesc.RenderTarget[0].BlendOpAlpha = D3D12_BLEND_OP_ADD;
	blendDesc.RenderTarget[0].RenderTargetWriteMask = D3D12_COLOR_WRITE_ENABLE_ALL;
	blendDesc.RenderTarget[0].SrcBlend = D3D12_BLEND_ONE;  // ソース色をそのまま使用
blendDesc.RenderTarget[0].DestBlend = D3D12_BLEND_ONE; // 背景色をそのまま使用
