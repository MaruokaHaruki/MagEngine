...
void EnemyManager::Initialize(MagEngine::Object3dSetup *object3dSetup,
	...
	// ウェーブ定義（5ウェーブ固定）
	waveConfigs_ = {
		{3, 0, 3.0f}, // Wave 1: 通常×3、ガンナー×0、間隔3.0秒
		{3, 1, 2.5f}, // Wave 2: 通常×3、ガンナー×1、間隔2.5秒
		{4, 2, 2.5f}, // Wave 3: 通常×4、ガンナー×2、間隔2.5秒
		{4, 3, 2.0f}, // Wave 4: 通常×4、ガンナー×3、間隔2.0秒
		{5, 3, 2.0f}, // Wave 5: 通常×5、ガンナー×3、間隔2.0秒
	};
